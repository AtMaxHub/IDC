 ...
 /*   @Override
  ...
  /*  @Override
    public boolean sqlMapInsertSelectiveElementGenerated(XmlElement element, IntrospectedTable introspectedTable) {
       doUseGeneratedKeys(element,introspectedTable);
       return true;
    }*/
    ...
    private void doUseGeneratedKeys(XmlElement element, IntrospectedTable introspectedTable){
        //定义是否需要生成三个属性
        boolean isGen = true;
        ...
        if (isGen) {
            ...
            if (keyColumns.size() == 1) {
                ...
                if (javaType.equals(PrimitiveTypeWrapper.getIntegerInstance()) || javaType.equals(PrimitiveTypeWrapper.getLongInstance()) || javaType.equals(PrimitiveTypeWrapper.getShortInstance())) {
                    ...
                    LOG.info(" ==>> propertyNames = {}",properties.propertyNames());
